...
const Maindash = () => {
  return (
    <>
     ...
     <div className="fixed w-full flex items-center justify-between h-14 z-10 bg-gray-900">
        <div className="flex items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-gray-700 dark:bg-gray-800 border-none text-white">
          <span className="hidden md:block">ADMIN</span>
        </div>
        <div className="flex justify-between items-center h-14 bg-gray-900 dark:bg-gray-800 header-right">
...
{/* <div className="antialiased bg-black w-full min-h-screen text-slate-300 relative py-4">
    ...
    <div className="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-gray-900 dark:bg-gray-900 h-full text-white transition-all duration-300 border-none z-10 sidebar">
        {/* <div id="menu" className=" md-w-64 bg-white/10 col-span-12 rounded-lg p-4 ">
            <Link to="/signup">
            <h1>signup</h1></Link>
          ...
          <ul className="flex flex-col py-4 space-y-1">
            ...
            <li>
              ...
              <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 dark:hover:bg-gray-600 text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                ...
                <span className="ml-2 text-sm tracking-wide truncate">Invoice</span>
