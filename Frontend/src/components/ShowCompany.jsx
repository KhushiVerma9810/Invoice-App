...
const ShowCompany = forwardRef((props, ref) => {
    const context = useContext(ClientContext);
    const { companies ,setSelectedComp,getCompany} = context;
  ...
  return (
    <div>
         <div ref={modalRef2} style={{ display: 'none' }}  data-te-modal-init
  ...
  role="dialog">
    ...
    <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8"> 
      ...
      <table class="min-w-full text-left text-sm font-light"> 
        ...
        companies.map((comp) => (
            <tr  key={comp._id}  className={`${
                selectedRow === comp._id ? 'bg-gray-500' : 'bg-gray-100'
